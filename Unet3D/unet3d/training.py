...
def get_callbacks(model_file, initial_learning_rate=0.0001, learning_rate_drop=0.5, learning_rate_epochs=None,
                  ...
                  early_stopping_patience=None, tensorboard_logdir = None):
    callbacks = list()
...
def load_old_model_EWC(model_file):
    print("Loading pre-trained model")
    custom_objects = {'dice_coefficient_loss': dice_coefficient_loss, 'dice_coefficient': dice_coefficient,
                      'dice_coef': dice_coef, 'dice_coef_loss': dice_coef_loss,
                      'weighted_dice_coefficient': weighted_dice_coefficient,
...
def train_model(model, model_file, training_generator, validation_generator, steps_per_epoch, validation_steps,
                ...
                learning_rate_patience=20, early_stopping_patience=None, logging_file='log.csv',tensorboard_logdir = None):
    """
    Train a Keras model.
    ...
    :param logging_file: file where loss and training is saved.
    :return: 
    """
