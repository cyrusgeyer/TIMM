...
def write_image_data_to_file(image_files, data_storage, padding, crop_slice,n_channels, affine_storage,
    ...
    for set_of_files in image_files:
        ...
        if normalize == 'hist_norm' or normalize == 'zero_one':
            ...
            subject_data = [
                ...
                for image in images]
        add_data_to_storage(data_storage, affine_storage, subject_data, np.eye(4), n_channels)
    return data_storage


def add_data_to_storage(data_storage, affine_storage, subject_data, affine, n_channels):

    print(np.asarray(subject_data).shape)
...
def write_data_to_file(training_data_files, out_file, subject_ids=None,
